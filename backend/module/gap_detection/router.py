...
from backend.module.gap_detection.orchestrator import _papers_to_refs, cold_start
from backend.module.gap_detection.query_cleaner import clean_query
from backend.module.gap_detection.schemas import GapReport, QueryRejectedError
...
from backend.module.gap_detection.streaming import stream_gap_detection
...
async def detect_gaps_cold_start(
    ...
    4. Returns a :class:`~backend.module.gap_detection.schemas.GapReport`.
...
# from backend.module.gap_detection.nodes.paper_check import MIN_SESSION_PAPERS
# from backend.module.gap_detection.schemas import PaperRef
# from backend.module.gap_detection.settings import get_max_papers_for_gap
#
