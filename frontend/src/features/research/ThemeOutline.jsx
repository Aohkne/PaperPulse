    ...
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '12px' }}>
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: '12px', color: 'var(--color-paper-mid)', margin: 0, lineHeight: '1.5' }}>
            {theme.description}
          </p>
        </div>
  ...
  if (themes.length === 0 && v2Running) {
    return (
      <div style={{
        ...
        <p style={{ fontSize: '14px', margin: 0 }}>Pipeline running… outline will appear at Step ④</p>
      </div>
    );
  }
    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      {isInterrupt && (
        <div style={{
          ...
          <Icon icon="mdi:pause-circle" style={{ fontSize: '16px', color: '#f59e0b', flexShrink: 0 }} />
