    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
        <div style={{
          ...
          <Icon icon="mdi:clipboard-text-search-outline" style={{ fontSize: '18px', color: 'var(--color-brand-600)' }} />
        </div>
        <div>
      ...
      {planDescription && (
        <p style={{
          fontSize: '13px', lineHeight: '1.6', color: 'var(--color-paper-dark)',
          background: 'var(--color-paper-surface)', borderRadius: '8px',
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', marginBottom: '14px' }}>
          ...
          <div key={i} style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
            <input
              ...
              style={{
                ...
                border: '1px solid var(--color-paper-light)', borderRadius: '6px',
        ...
        <button
          ...
          style={{
            ...
            fontSize: '11px', color: 'var(--color-brand-600)', background: 'transparent',
          ...
          return (
            <button
              ...
              style={{
                ...
                borderRadius: '20px', cursor: locked ? 'default' : 'pointer',
                border: active ? '1px solid var(--color-brand-600)' : '1px solid var(--color-paper-light)',
                background: active ? 'rgba(99,102,241,0.1)' : 'transparent',
                color: active ? 'var(--color-brand-600)' : 'var(--color-paper-light)',
                opacity: locked ? 0.85 : 1,
              }}
            >
              <Icon icon={active ? 'mdi:check-circle' : 'mdi:circle-outline'} style={{ fontSize: '13px' }} />
              {label}
