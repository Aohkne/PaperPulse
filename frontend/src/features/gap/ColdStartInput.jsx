      ...
      <div style={{ padding: '18px 20px 14px' }}>
        ...
        <textarea
          ...
          onChange={(e) => {
            ...
            if (gapRejected) useGapStore.setState({ gapRejected: null });
          }}
          ...
          placeholder={
            quotaExhausted
              ...
              : 'Enter research topic... (e.g. transformer long-context NLP)'
          }
          rows={2}
          style={{
            width: '100%',
        ...
        {gapRejected && (
          ...
          >
            <Icon
              ...
              style={{
                fontSize: '17px',
                color: gapRejected.reason === 'injection' ? '#8B4A2F' : 'var(--color-paper-mid)',
                flexShrink: 0,
                marginTop: '1px',
              }}
            />
