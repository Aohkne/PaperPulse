  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: hovered ? '6px 14px 36px rgba(41,17,0,0.18)' : '3px 6px 20px rgba(41,17,0,0.10)',
        cursor: 'default',
  ...
  >
    ...
    <div style={{ paddingTop: 57 }}>
      ...
      <section style={{ maxWidth: 720, margin: '0 auto', padding: '80px 24px 64px' }}>
        ...
        >
          Researchers spend weeks combing through hundreds of papers before writing a single
          paragraph. PaperPulse compresses that into hours — without sacrificing the rigor that
        ...
        >
          We built PaperPulse because we experienced this pain firsthand: too many papers, too
          little time, and existing AI tools that fabricated sources with alarming confidence.
          Accuracy isn't optional in academic work — so we made it the foundation.
        </motion.p>
      </section>
