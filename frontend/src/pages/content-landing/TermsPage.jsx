    ...
    <div style={{ paddingTop: 57 }}>
      <article style={{ maxWidth: 720, margin: '0 auto', padding: '80px 24px 80px' }}>
        ...
        <motion.div {...scrollUp(0.1)}>
          ...
          <p style={prose}>
            By accessing or using PaperPulse, you agree to be bound by these Terms of Service. If
            you do not agree to these terms, please do not use the service.
          </p>

          <h2 style={h2Style}>2. Acceptable Use</h2>
          <p style={prose}>
            PaperPulse is intended for academic, educational, and personal research purposes. You
            agree not to:
          </p>
          <ul style={{ ...prose, paddingLeft: 24, margin: '0 0 16px' }}>
            <li style={{ marginBottom: 8 }}>
              Resell, sublicense, or commercially redistribute PaperPulse outputs without our
              written permission.
            </li>
            <li style={{ marginBottom: 8 }}>
            ...
            <li style={{ marginBottom: 8 }}>
              Systematically scrape or extract data from PaperPulse in bulk.
            </li>
          </ul>

          <h2 style={h2Style}>3. No Warranty on Accuracy</h2>
          <p style={prose}>
            PaperPulse uses AI and automated verification pipelines to generate literature reviews.
            While we take significant steps to ensure citation accuracy, AI-generated content may
            contain errors, omissions, or outdated information.
          </p>
          <p style={prose}>
            Users are responsible for verifying all claims before using them in published academic
            work. PaperPulse is a research aid — it does not replace professional academic judgment
            or peer review.
          </p>

          <h2 style={h2Style}>4. Intellectual Property</h2>
          <p style={prose}>
            The PaperPulse platform, interface, and underlying technology are proprietary to Team
            C2-App-069. Paper content retrieved from Semantic Scholar remains subject to each
            paper's original license and copyright. PaperPulse does not claim ownership over any
          ...
          <p style={prose}>
            ...
            in abusive behavior, or misuse the service. We will notify you where possible before
            taking action.
          </p>

          <h2 style={h2Style}>6. Limitation of Liability</h2>
          <p style={prose}>
            To the maximum extent permitted by law, PaperPulse is provided "as is" without warranty
            of any kind. We are not liable for any indirect, incidental, or consequential damages
            arising from your use of the service, including any errors in generated literature
            reviews.
          </p>

          <h2 style={h2Style}>7. Changes to Terms</h2>
          <p style={prose}>
            We may update these Terms of Service from time to time. Continued use of PaperPulse
