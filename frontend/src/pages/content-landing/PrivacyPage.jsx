    ...
    <div style={{ paddingTop: 57 }}>
      <article style={{ maxWidth: 720, margin: '0 auto', padding: '80px 24px 80px' }}>
        ...
        <motion.div {...scrollUp(0.1)}>
          ...
          <p style={prose}>
            This Privacy Policy explains how PaperPulse ("we", "us", or "our") collects, uses, and
            protects information about you when you use our service. By using PaperPulse, you agree
            to the collection and use of information as described here.
          </p>

          <h2 style={h2Style}>2. Information We Collect</h2>
          <p style={prose}>
            <strong style={{ color: 'var(--color-paper-dark)' }}>Account data:</strong> When you
            register, we collect your email address and a hashed password via Supabase Auth. We do
            not store your password in plain text.
          </p>
          <p style={prose}>
            <strong style={{ color: 'var(--color-paper-dark)' }}>Usage data:</strong> We store the
            research queries you submit and the literature reviews you save, so you can revisit them
            later. This data is associated with your account.
          </p>
          <p style={prose}>
            We do not collect location data, device fingerprints, or behavioral tracking data. We do
            not serve ads and do not share your data with advertising networks.
          </p>
          ...
          <p style={prose}>
            ...
            provider. We will store only your subscription status and transaction history — not your
            payment credentials. This policy will be updated when payment features launch.
          </p>
          ...
          <p style={prose}>
            ...
            <Link to="/community" style={{ color: 'var(--color-paper-dark)' }}>
              community
            </Link>{' '}
