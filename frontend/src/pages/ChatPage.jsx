...
const PILLARS = [
  ...
  },
  {
    ...
    title: 'Research Gaps',
    description: 'Surface contradictions and understudied angles.',
  },
  {
    key: 'knowledge-graph',
    icon: 'mdi:graph-outline',
    title: 'Knowledge Graph',
    description: 'Visualise connections between papers and topics.',
  },
  {
    key: 'pdf-agent',
    icon: 'mdi:file-search-outline',
    title: 'PDF Agent',
    description: 'Upload a PDF to critique and verify its citations.',
  },
];
...
const WelcomeInput = () => {
  ...
  const handlePillarClick = (key) => {
    ...
    if (key === 'literature-review') {
      setShowLRExamples(true);
      return;
    }
  };
        ...
        <textarea
          ...
          placeholder={
            quotaExhausted
              ...
              : 'Describe the topic, research question, and requirements...'
          }
          style={{
            width: '100%',
            border: 'none',
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          <button
            ...
            style={{
              ...
              background:
                text.trim() && !quotaExhausted ? 'var(--color-paper-mid)' : 'var(--color-paper-bg)',
              border: 'none',
              borderRadius: '50%',
              width: 38,
              height: 38,
          ...
          >
            ...
            {LITERATURE_REVIEW_EXAMPLES.map((example) => (
              ...
              >
                <Icon
                  icon="mdi:text-search"
                  style={{ fontSize: 18, color: 'var(--color-brand-500)', flexShrink: 0 }}
                />
                <span
                  style={{
                    fontFamily: "'Newsreader', serif",
          ...
          >
            {PILLARS.map(({ key, icon, title, description }) => (
              ...
              >
                ...
                <span
                  style={{ fontSize: '12.5px', lineHeight: 1.5, color: 'var(--color-paper-mid)' }}
                >
                  {description}
                </span>
              </button>
...
const ChatPage = () => {
  ...
  const isHydratingPersistedSession =
    activeSession?.persisted && activeSession?.status === 'loading' && activeMessages.length === 0;
  ...
  // shared/components/layout/ChatLayout.jsx.
