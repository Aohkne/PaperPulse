"""Tests for TIP-P3-05 Ã¢â‚¬â€ explicit_detector + verifier EXPLICIT routing.
...
# Ã¢â€â‚¬Ã¢â€â‚¬ detect_origin unit tests Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬


def test_detect_origin_explicit_future_work():
    """'Future work should explore X' Ã¢â€ â€™ EXPLICIT, confidence=1.0"""
...
def test_detect_origin_explicit_open_question():
    """'remains an open problem' Ã¢â€ â€™ EXPLICIT"""
...
def test_detect_origin_explicit_further_investigation():
    """'warrants further investigation' Ã¢â€ â€™ EXPLICIT"""
...
def test_detect_origin_limitation_limited_to():
    """'Our method is limited to short sequences' Ã¢â€ â€™ LIMITATION, confidence=0.9"""
...
def test_detect_origin_limitation_key_limitation():
    """'A key limitation is...' Ã¢â€ â€™ LIMITATION"""
...
def test_detect_origin_inferred_no_match():
    """No pattern match Ã¢â€ â€™ INFERRED, confidence=0.0"""
...
def test_detect_origin_inferred_empty():
    """Empty statement Ã¢â€ â€™ INFERRED"""
...
def test_detect_origin_limitation_wins_over_explicit_in_statement():
    """Statement with both limitation + future-work signals Ã¢â€ â€™ LIMITATION (statement-level limit wins)."""
...
# Ã¢â€â‚¬Ã¢â€â‚¬ verifier_node routing tests Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
async def test_verifier_explicit_bypasses_nli():
    """EXPLICIT gap Ã¢â€ â€™ NLI not called, confidence=1.0, verified=True."""
...
async def test_verifier_inferred_goes_through_existing_logic():
    """INFERRED gap with supporting papers Ã¢â€ â€™ verified=True, NLI not called."""
...
async def test_verifier_preannotates_inferred_to_explicit():
    """INFERRED gap whose statement matches EXPLICIT pattern Ã¢â€ â€™ upgraded before routing."""
    gap = _make_gap(
...
async def test_verifier_limitation_still_goes_through_nli():
    """LIMITATION gap Ã¢â€ â€™ NLI IS called (existing behavior preserved)."""
    gap = _make_gap(
    ...
    with (
        patch(f"{_VERIFIER}.verify_claims", new_callable=AsyncMock) as mock_verify,
...
async def test_verifier_limitation_not_overwritten_by_preannotation():
    ...
    # Statement has no limitation pattern Ã¢â‚¬â€ but origin is already LIMITATION
