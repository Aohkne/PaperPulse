...
```toml
[project]
name = "lit-surveyor-agent"          # Tên dự án của bạn
version = "0.1.0"
description = "AI Assistant for Literature Review and Research Gap Detection"  # Mô tả ngắn gọn
authors = [
    {name = "Team 69"},
]

[project.urls]
repository = "https://github.com/AI20K-Build-Cohort-2/C2-App-069"  # URL repo của bạn
```
